# Generated by Django 4.0.4 on 2023-01-10 03:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sessions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SessionHistory',
            fields=[
                ...
                ('session_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendee', to='checkins.session')),
            ],
        ),
    ]
